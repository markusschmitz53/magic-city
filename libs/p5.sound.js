 ...
 * https://github.com/processing/processing/tree/master/java/libraries/sound
 *
...
envelope = function () {
   ...
   *  Use <code><a href="#/p5.Envelope/setADSR">setADSR</a></code> to change attackTime, decayTime, sustainPercent and
   * releaseTime.</p>
...
audioin = function () {
  ...
  p5.AudioIn.prototype.start = function (successCallback, errorCallback) {
    ...
    console.info('custom constraints active!');
    // all available constraints: navigator.mediaDevices.getSupportedConstraints();
...
compressor = function () {
  ...
  p5.Compressor = function () {
    Effect.call(this);
    /**
       * The p5.Compressor is built with a <a
       * href="https://www.w3.org/TR/webaudio/#the-dynamicscompressornode-interface"  target="_blank" title="W3 spec
       * for Dynamics Compressor Node">Web Audio Dynamics Compressor Node
     *   </a>
