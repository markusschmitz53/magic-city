var crewActive,
	...
	class magicCity {
		...
		setup ()
		{
			...
			this.textureBackgroundPane = createBackgroundGradient(windowWidth, windowHeight, color('#39485A'), this.backgroundColor);
...
*/
		...
		earthquake () {
			if (!this.earthquakeActive) {
				...
				this.textureBackgroundPane = createBackgroundGradient(windowWidth, windowHeight, color('#FF0000'), this.backgroundColor);
				this.moonTempo = 15;
